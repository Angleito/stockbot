...
- `item` (object): Finding whose provenance must match its claim_kind: the get_sec_document source_handle + cited passage for observed_fact, search scope for absence_observation.
