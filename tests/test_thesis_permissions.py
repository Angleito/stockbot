...
def test_research_default_hides_broker_tools_despite_env(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    names = {_tool_name(t) for t in tools_for_capabilities(_ctx().capabilities)}
...
def test_thesis_tools_allowed_under_research_intent() -> None:
...
def test_thesis_show_readable_under_research_only() -> None:
