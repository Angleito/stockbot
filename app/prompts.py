...
Use the single most canonical tool for the question; call a named prerequisite first when usage notes require it, then stop. Do not chain follow-up or verification tools.
When several tools match, describe the top-ranked match first; only move down the list when its usage notes exclude the question.
